...
$$
\mathbb{E}(Y_t) = Y_0 + \delta t, \quad \text{since } \mathbb{E} \left( \int_0^t 2\sqrt{Y_r} \, dW_r  | F_s\right) = 0
$$
...
Assuming no discounting factor, i.e $r=0$ thus $e^{-rt}=1$, the pricing formula of the Bermuda call option is $E(max((Rti-K)^+, E(V_{i+1}|Fi)))$, where $V_{i+1}$ is the future value.
